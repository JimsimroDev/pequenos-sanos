...
/**
 * Global exception handler that intercepts unhandled exceptions thrown by controllers
 * and converts them into structured JSON error responses with appropriate HTTP status codes.
 */
...
public class TratadorDeErrores {
    ...
    /**
     * Handles access denied exceptions (authenticated but insufficient permissions).
     *
     * @param ex the exception
